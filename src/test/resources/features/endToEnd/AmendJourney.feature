...
Feature: Is the members details journey fully connected
  ...
  Scenario:1. Amend Journey - Change member,transfer,QROPS and schemeManager details
    ...
    And I should see two radio buttons: "View this overseas pension transfer" and "Amend this overseas pension transfer"
    When I select radio button "Amend this overseas pension transfer" on "View Amend Page"
