@Test  @acceptance  @journey @CashMiniJourney
Feature: Unquoted Share Mini journey(Adding  and removing Unquoted Shares)
  ...
  Scenario:1. PSA/PSP user is able to transfer a Cash and Unquoted Shares
    ...
    When I click on "unquoted-shares-company-name" button on "Unquoted Share Check Your Answers Page"
    Then I am presented with the "Name Of Company Unquoted Share Page"
    When I enter the following data into corresponding input fields on "Name Of Company Unquoted Share Page"
      | value | Company ABC|
    And I click save and continue button on "Name Of Company Unquoted Share Page"
    When I click on "unquoted-shares-value" button on "Unquoted Share Check Your Answers Page"
    Then I am presented with the "Value Of Unquoted Share Page"
    When I enter the following data into corresponding input fields on "Value Of Unquoted Share Page"
      | value | 5000 |
    And I click save and continue button on "Value Of Unquoted Share Page"
    When I click on "unquoted-shares-number" button on "Unquoted Share Check Your Answers Page"
    Then I am presented with the "Number Of Unquoted Share Page"
    When I enter the following data into corresponding input fields on "Number Of Unquoted Share Page"
      | value | 10 |
    And I click save and continue button on "Number Of Unquoted Share Page"
    When I click on "unquoted-shares-class" button on "Unquoted Share Check Your Answers Page"
    Then I am presented with the "Class Of Unquoted Share Page"
    When I enter the following data into corresponding input fields on "Class Of Unquoted Share Page"
      | value | Class B |
    ...
    And I click save and continue button on "Type Of Asset Page"
    Then I am presented with the "Change Quoted Share Start Page"
    And I should see the following values on the page
    ...
    Then I am presented with the "Change Quoted Share Company Name Page"
    And I should see the heading "What is the name of the company these quoted shares relate to?"
    When I enter the following data into corresponding input fields on "Change Quoted Share Company Name Page"
      | value | Company XYZ|
    And I click save and continue button on "Change Quoted Share Company Name Page"
    Then I am presented with the "Change Quoted Share Value Page"
    When I enter the following data into corresponding input fields on "Change Quoted Share Value Page"
      | value | 500 |
    And I click save and continue button on "Change Quoted Share Value Page"
    Then I am presented with the "Change Quoted Share Number Page"
    And I should see the heading "How many quoted shares in this company are part of this transfer?"
    When I enter the following data into corresponding input fields on "Change Quoted Share Number Page"
      | value | 100 |
    And I click save and continue button on "Change Quoted Share Number Page"
    Then I am presented with the "Change Quoted Share Class Page"
    And I should see the heading "What class are these quoted shares?"
    When I enter the following data into corresponding input fields on "Change Quoted Share Class Page"
      | value | Class A|
    And I click save and continue button on "Change Quoted Share Class Page"
    Then I am presented with the "Change Unquoted To Quoted Share Check Your Answers Page"
    And I click save and continue button on "Change Unquoted To Quoted Share Check Your Answers Page"
