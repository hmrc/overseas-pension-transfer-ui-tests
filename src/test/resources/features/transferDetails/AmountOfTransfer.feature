...
And I navigated to the "Amount Of Transfer Page"
Then I am presented with the "Amount Of Transfer Page"
And I should see the heading "What is the amount of the transfer?"
And I should see the hint text "For example, £60000 or £19,300.54."
  ...
  Scenario:9. Positive journey - PSA/PSP types in a numerical value into the field with comma (,) separator in any position
    When I click on the Details component "Help with available allowance" on "Amount Of Transfer Page"
