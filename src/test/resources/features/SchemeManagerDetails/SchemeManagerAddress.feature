@Test @SchemeManagerAddress @acceptance
Feature: Entering the address of the Scheme Manager
  ...
  Background: Common Steps - Member Details Journey
    ...
    And I navigated to the "Organisation Individual Address Page"
  ...
  Scenario Outline: Verify the Members Last UK Address Page
    And I should see the heading "What is the scheme manager's address?"
    And I should see the input fields with below labels on "Organisation Individual Address Page"
      | Address line 1            |
      | Address line 2            |
  ...
  #   When I click "postcode" on "Members Current UK Address Page"
    And I click save and continue button on "Organisation Individual Address Page"
...
# Above action would have to be rewritten upon page gets connected
  ...
  Scenario:3. Negative journey - PSA/PSP enters more than 35 charecters for 'Address Line 1' in the Scheme Manager address page
    When I enter the following data into corresponding input fields on "Organisation Individual Address Page"
      ...
      | countryCode  | United Kingdom                                                                      |
    And I click save and continue button on "Organisation Individual Address Page"
    Then I am presented with the "Organisation Individual Address Page" error page
    And I should see the "There is a problem" and below error messages
      | Address line 1 must be 35 characters or less |
    And I should see following erroneous fields are highlighted on "Organisation Individual Address Page"
      |addressLine1 |
    And Clicking each error message should focus on the corresponding input field on "Organisation Individual Address Page"

  Scenario:4. Negative journey - PSA/PSP enters more than 35 characters for 'Address Line 2' in the Scheme Manager address page
    When I enter the following data into corresponding input fields on "Organisation Individual Address Page"
  ...
  Scenario:5. Negative journey - PSA/PSP enters more than 35 characters for 'Address Line 3' in the Scheme Manager address page
    When I enter the following data into corresponding input fields on "Organisation Individual Address Page"
      | addressLine1 | 12 Burlington Court                                                                 |
      | addressLine2 | Burlington Road                                                                     |
  ...
  Scenario:6. Negative journey - PSA/PSP enters more than 35 characters for 'Address Line 4' in the Scheme Manager address page
    When I enter the following data into corresponding input fields on "Organisation Individual Address Page"
      | addressLine1 | 12 Burlington Court                                                                 |
      | addressLine2 | Burlington Road                                                                     |
      | addressLine3 | London                                                                              |
  ...
  Scenario:7. Negative journey - PSA/PSP enters more than 35 characters for 'Address Line 5' in the Scheme Manager address page
    When I enter the following data into corresponding input fields on "Organisation Individual Address Page"
      | addressLine1 | 12 Burlington Court                                                                 |
      | addressLine2 | Burlington Road                                                                     |
      | addressLine3 | Maidenhead                                                                          |
  ...
  Scenario:8. Negative journey - PSA/PSP does not enter the 'Address Line 1' in the Scheme Manager address page
    When I enter the following data into corresponding input fields on "Organisation Individual Address Page"
      | addressLine1 |                 |
      | addressLine2 | Burlington Road |
      | addressLine3 | London          |
    ...
    Then I am presented with the "Organisation Individual Address Page" error page
    And I should see the "There is a problem" and below error messages
      | Enter the first line of the scheme manager's address |
    And I should see following erroneous fields are highlighted on "Organisation Individual Address Page"
      | addressLine1 |
    And Clicking each error message should focus on the corresponding input field on "Organisation Individual Address Page"

  Scenario:9. Negative journey - PSA/PSP does not enter the 'Address Line 2' in the Scheme Address address page
    When I enter the following data into corresponding input fields on "Organisation Individual Address Page"
      | addressLine1 | 12 Burlington Court |
      | addressLine2 |                     |
      | addressLine3 | London              |
    ...
    Then I am presented with the "Organisation Individual Address Page" error page
    And I should see the "There is a problem" and below error messages
      | Enter the second line of the scheme manager's address |
    And I should see following erroneous fields are highlighted on "Organisation Individual Address Page"
      | addressLine2 |
    And Clicking each error message should focus on the corresponding input field on "Organisation Individual Address Page"

  Scenario:10. Negative journey - PSA/PSP does not enter the 'Country' field in Scheme Manager address page
    When I enter the following data into corresponding input fields on "Organisation Individual Address Page"
      | addressLine1 | 12 Burlington Court |
      | addressLine2 | Burlington Road     |
      | addressLine3 | London              |
...
#      | countryCode |
  ...
  Scenario:11. Negative journey - PSA/PSP enters invalid charecters in Address Line 1 field in Scheme Manager address page
    When I enter the following data into corresponding input fields on "Organisation Individual Address Page"
      | addressLine1 | %12 Burlington Court |
      | addressLine2 | Burlington Road      |
      | addressLine3 | London               |
  ...
  Scenario:12. Negative journey - PSA/PSP enters invalid charecters in Address Line 2 field in Scheme Manager address page
    When I enter the following data into corresponding input fields on "Organisation Individual Address Page"
      | addressLine1 | 12 Burlington Court |
      | addressLine2 | %Burlington Road    |
      | addressLine3 | London              |
  ...
  Scenario:13. Negative journey - PSA/PSP enters invalid charecters in Address Line 3 field in Scheme Manager address page
    When I enter the following data into corresponding input fields on "Organisation Individual Address Page"
      | addressLine1 | 12 Burlington Court |
      | addressLine2 | Burlington Road     |
      | addressLine3 | %London             |
  ...
  Scenario:14. Negative journey - PSA/PSP enters invalid charecters in Address Line 4 field in Scheme Manager address page
    When I enter the following data into corresponding input fields on "Organisation Individual Address Page"
      | addressLine1 | 12 Burlington Court |
      | addressLine2 | Burlington Road     |
      | addressLine3 | London              |
  ...
  Scenario:15. Negative journey - PSA/PSP enters invalid charecters in Address Line 5 field in Scheme Manager address page
    When I enter the following data into corresponding input fields on "Organisation Individual Address Page"
      | addressLine1 | 12 Burlington Court |
      | addressLine2 | Burlington Road     |
      | addressLine3 | London              |
