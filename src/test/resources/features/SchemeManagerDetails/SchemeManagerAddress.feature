...
Feature: Entering the address of the Scheme Manager
  ...
  Background: Common Steps - Member Details Journey
    ...
    And I navigated to the "Scheme Manager Address Page"
  ...
  Scenario Outline: Verify the Members Last UK Address Page
    ...
    And I should see the input fields with below labels on "Scheme Manager Address Page"
      | Address line 1            |
      | Address line 2            |
  ...
  Scenario:3. Negative journey - PSA/PSP enters more than 35 charecters for 'Address Line 1' in the Scheme Manager address page
    When I enter the following data into corresponding input fields on "Scheme Manager Address Page"
      ...
      | countryCode  | United Kingdom                                                                      |
    And I click save and continue button on "Scheme Manager Address Page"
    Then I am presented with the "Scheme Manager Address Page" error page
    And I should see the "There is a problem" and below error messages
      | Address line 1 must be 35 characters or less |
    And I should see following erroneous fields are highlighted on "Scheme Manager Address Page"
      |addressLine1 |
    And Clicking each error message should focus on the corresponding input field on "Scheme Manager Address Page"
