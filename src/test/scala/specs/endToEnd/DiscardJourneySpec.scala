...
import specs.tags.{AllTests, DiscardJourney}
  ...
  Feature("Is the members discard transfer") {
    ...
    )
    {
     ...
     thenIAmPresentedWithThe("Final Check Your Answers Page")
      ...
      When("I click on Discard Transfer Report hyperlink on Final Check Your Answers Page")
      whenIClickDiscardTransferReportsLink("Final Check Your Answers Page")
