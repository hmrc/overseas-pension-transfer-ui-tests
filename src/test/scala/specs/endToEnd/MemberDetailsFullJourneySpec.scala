...
class MemberDetailsFullJourneySpec extends BaseSpec {

  Feature("Member details journey") {
    ...
    Scenario(
      ...
      When("I enter the following data into corresponding input fields on Members Current Address Page")
        Ienterthefollowingdataintocorrespondinginputfieldson (
          Map("addressLine1" -> "12 Burlington Avenue","addressLine2" -> "Burlington Road","addressLine3" -> "Maidenhead","addressLine4" -> "Berkshire","countryCode" -> "United Kingdom","postcode" -> "AB12CD","poBox" -> "11223344")
        )
    ...
    Scenario(
      ...
      And("I click save and continue button on Members Last UK Address Page")
        whenIClickSaveAndContinueButtonOn("Members Last UK Address Page")
