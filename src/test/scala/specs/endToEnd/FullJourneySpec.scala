...
class FullJourneySpec extends BaseSpec {

  Feature("Full submission journeys") {
    Scenario (
      ...
      When("I click on final-change-members-current-address button on Final Check Your Answers Page")
        whenIClickOnButtonOn("final-change-members-current-address")
      ...
      When("I click on final-change-amount-of-transfer button on Final Check Your Answers Page")
        whenIClickOnButtonOn("final-change-amount-of-transfer")
      ...
      When("I click on final-change-qrops-reference button on Final Check Your Answers Page")
        whenIClickOnButtonOn("final-change-qrops-reference")
      ...
      When("I click on final-change-scheme-managers-name button on Final Check Your Answers Page")
        whenIClickOnButtonOn("final-change-scheme-managers-name")
    ...
    Scenario(
      ...
      When("I enter the correct PSAID on the Psp Declaration Page")
        Ienterthefollowingdataintocorrespondinginputfieldson (
          Map("value" -> "A2100005")
        )
      And("I click agree and submit button on Declaration Page")
