...
object OrganisationNamePage extends BasePage {
  ...
  override def expectedPageErrorTitle: Option[String] = Some(
    "Error: What is the name of the organisation? - Report an overseas pension transfer - GOV.UK"
  )

  override def expectedPageTitle: Option[String] = Some(
    "What is the name of the organisation? - Report an overseas pension transfer - GOV.UK"
  )
}
