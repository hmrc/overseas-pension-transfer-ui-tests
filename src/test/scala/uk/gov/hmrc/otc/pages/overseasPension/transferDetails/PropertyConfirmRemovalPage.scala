...
object PropertyConfirmRemovalPage extends BasePage {
  ...
  override def expectedPageTitle: Option[String] = Some(
    "Are you sure you want to remove this property? - Report a transfer to a qualified recognised overseas pension scheme - GOV.UK"
  )
}
