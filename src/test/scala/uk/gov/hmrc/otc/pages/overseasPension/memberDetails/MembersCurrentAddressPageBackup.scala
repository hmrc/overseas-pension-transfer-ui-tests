...
object MembersCurrentAddressPageBackup extends BasePage {

  override val url: String = TestConfiguration.url("overseas-pension-transfer-frontend") + "/member-details/members-current-address"
  override val title       = s"What is the member's current address? - Report a transfer to a qualifying recognised overseas pension scheme - GOV.UK"
