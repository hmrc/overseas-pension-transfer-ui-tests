...
object MemberDateOfBirthPage extends BasePage {
  ...
  override def expectedPageErrorTitle: Option[String] = Some(
    s"Error: What is $expectedFullName’s date of birth? - Report a transfer to a qualifying recognised overseas pension scheme - GOV.UK"
  )

  override def expectedPageTitle: Option[String] = Some(
    s"What is $expectedFullName’s date of birth? - Report a transfer to a qualifying recognised overseas pension scheme - GOV.UK"
  )
