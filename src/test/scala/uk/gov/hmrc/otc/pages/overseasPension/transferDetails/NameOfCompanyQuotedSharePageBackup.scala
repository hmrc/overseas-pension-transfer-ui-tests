...
object NameOfCompanyQuotedSharePageBackup extends BasePage {

  override val url: String = TestConfiguration.url("overseas-pension-transfer-frontend") + "/transfer-details/assets/quoted-shares-company-name?index=0"
