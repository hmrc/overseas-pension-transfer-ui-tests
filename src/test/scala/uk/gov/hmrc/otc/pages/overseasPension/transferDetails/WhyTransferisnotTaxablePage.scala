...
object WhyTransferisnotTaxablePage extends BasePage {
  ...
  override def expectedPageErrorTitle: Option[String] = Some(
    "Error: Why isn't this a taxable overseas transfer? - Report a transfer to a qualified recognised overseas pension scheme - GOV.UK"
  )

  override def expectedPageTitle: Option[String] = Some(
    "Why isn't this a taxable overseas transfer? - Report a transfer to a qualified recognised overseas pension scheme - GOV.UK"
  )
}
