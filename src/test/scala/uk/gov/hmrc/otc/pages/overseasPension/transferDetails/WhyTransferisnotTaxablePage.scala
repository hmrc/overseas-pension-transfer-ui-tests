...
object WhyTransferisnotTaxablePage extends BasePage {
  ...
  override def expectedPageErrorTitle: Option[String] = Some(
    "Error: Why isn't this a taxable overseas transfer? - Report an overseas pension transfer - GOV.UK"
  )

  override def expectedPageTitle: Option[String] = Some(
    "Why isn't this a taxable overseas transfer? - Report an overseas pension transfer - GOV.UK"
  )
}
