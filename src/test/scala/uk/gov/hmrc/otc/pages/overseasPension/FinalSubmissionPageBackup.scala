...
object FinalSubmissionPageBackup extends BasePage {

  override val url: String = TestConfiguration.url("overseas-pension-transfer-frontend") + "/submit-to-hmrc"
  override val title = " Do you want to submit this report to HMRC? - Report a transfer to a qualifying recognised overseas pension scheme - GOV.UK"
