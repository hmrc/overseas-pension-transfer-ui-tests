  ...
  Feature("Is the members details journey fully connected") {
    ...
    Scenario("1. Full Journey - Start a new transfer") {
      ...
      And("I should see the heading What is the member's name?")
        // ⚠️ No step-def match found for: I should see the heading What is the member's name?
      ...
      And("I should see the heading You have added 1 group of unquoted shares")
        // ⚠️ No step-def match found for: I should see the heading You have added 1 group of unquoted shares
      ...
      And("I should see the heading You have added 1 group of quoted shares")
        // ⚠️ No step-def match found for: I should see the heading You have added 1 group of quoted shares
      ...
      And("I should see the heading You have added 2 groups of quoted shares")
        // ⚠️ No step-def match found for: I should see the heading You have added 2 groups of quoted shares
      ...
      And("I should see the heading You have added 1 property")
        // ⚠️ No step-def match found for: I should see the heading You have added 1 property
      ...
      And("I should see the heading You have added 1 asset")
        // ⚠️ No step-def match found for: I should see the heading You have added 1 asset
